...
class CharacterCard(BaseModel):
    """Stored character card info for reuse / display"""
    id: Optional[int] = None
    token_id: Optional[int] = None
    username: str
    display_name: str
    description: Optional[str] = None   # Text prompt / instruction set
    character_id: Optional[str] = None  # Sora character id
    cameo_id: Optional[str] = None      # Source cameo id
    avatar_path: Optional[str] = None   # Relative path (e.g. /tmp/xxx.png)
    source_video: Optional[str] = None  # Original file name (if known)
    created_at: Optional[datetime] = None
