...
class SoraClient:
    ...
    async def generate_video(self, prompt: str, token: str, orientation: str = "landscape",
                            ...
                            cameo_ids: Optional[list] = None, cameo_replacements: Optional[dict] = None) -> str:
        ...
        if cameo_ids:
            json_data["cameo_ids"] = cameo_ids
        if cameo_replacements:
            json_data["cameo_replacements"] = cameo_replacements
    ...
    async def generate_storyboard(self, prompt: str, token: str, orientation: str = "landscape",
                                 media_id: Optional[str] = None, n_frames: int = 450,
                                 cameo_ids: Optional[list] = None) -> str:
